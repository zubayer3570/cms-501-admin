...
export default function Logout() {
    return (
        <body className="flex items-center justify-center min-h-screen py-16 lg:py-10 bg-slate-50 dark:bg-zink-800 dark:text-zink-100 font-public">
                    ...
                    <div className="!px-10 !py-12 card-body">
                        ...
                        <div className="mt-8 text-center">
                            <div className="mb-4 text-center">
                                <i data-lucide="log-out" className="mx-auto text-purple-500 size-6 fill-purple-100"></i>
                            </div>
                        ...
                        <a href="auth-login-basic.html" className="w-full text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">Sign In</a>
                    </div>
                </div>
            </div>
