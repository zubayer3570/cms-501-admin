...
export default function MainContent() {
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
                <div className="relative col-span-12 overflow-hidden card 2xl:col-span-8 bg-slate-900">
                    <div className="absolute inset-0">
                        <svg xmlns="http://www.w3.org/2000/svg" className="size-100" version="1.1"
                            xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="http://svgjs.dev/svgjs" width="1440"
                            ...
                            <symbol id="SvgjsSymbol1007">
                                ...
                                <use xlinkHref="#SvgjsPath1006" x="150" y="330" stroke="rgba(32, 43, 61, 1)"
                                    stroke-width="3"></use>
                                ...
                                <use xlinkHref="#SvgjsPath1006" x="210" y="150" stroke="rgba(32, 43, 61, 1)"
                                    stroke-width="3"></use>
                                ...
                                <use xlinkHref="#SvgjsPath1006" x="210" y="510" stroke="rgba(32, 43, 61, 1)"
                                    stroke-width="3"></use>
                                ...
                                <use xlinkHref="#SvgjsPath1006" x="270" y="390" stroke="rgba(32, 43, 61, 1)"
                                    stroke-width="3"></use>
                                ...
                                <use xlinkHref="#SvgjsPath1006" x="330" y="90" stroke="rgba(32, 43, 61, 1)"
                                    stroke-width="3"></use>
                                ...
                                <use xlinkHref="#SvgjsPath1006" x="330" y="270" stroke="rgba(32, 43, 61, 1)"
                                    stroke-width="3"></use>
                                ...
                                <use xlinkHref="#SvgjsPath1006" x="510" y="390" stroke="rgba(32, 43, 61, 1)"
                                    stroke-width="3"></use>
                                ...
                                <use xlinkHref="#SvgjsPath1006" x="570" y="390" stroke="rgba(32, 43, 61, 1)"
                                    stroke-width="3"></use>
                                ...
                                <use xlinkHref="#SvgjsPath1006" x="630" y="330" stroke="rgba(32, 43, 61, 1)"
                                    stroke-width="3"></use>
                                <use xlinkHref="#SvgjsPath1002" x="630" y="390" stroke="rgba(32, 43, 61, 1)"></use>
                                <use xlinkHref="#SvgjsPath1006" x="630" y="450" stroke="rgba(32, 43, 61, 1)"
                                    stroke-width="3"></use>
                                ...
                                <use xlinkHref="#SvgjsPath1006" x="690" y="510" stroke="rgba(32, 43, 61, 1)"
                                    stroke-width="3"></use>
                    ...
                    <div className="relative card-body">
                        <div className="grid items-center grid-cols-12">
                            <div className="col-span-12 lg:col-span-8 2xl:col-span-7">
                                ...
                                <p className="mb-5 text-slate-400">An ecommerce dashboard has just that purpose. It provides
                                    your ecommerce team with a clear overview of key financial and website KPIs at any
                                    time.</p>
                                <button type="button"
                            ...
                            <div
                                className="hidden col-span-12 2xl:col-span-3 lg:col-span-2 lg:col-start-11 2xl:col-start-10 lg:block">
                                <img src="/assets/images/dashboard.png" alt=" /" className="h-40 ltr:2xl:ml-auto rtl:2xl:mr-auto" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="card-body">
                        <div className="flex items-center mb-3">
                            ...
                            <div className="relative">
                                <a href="#!"
                                    className="underline transition-all duration-200 ease-linear text-custom-500 hover:text-custom-600">View
                                    All <i data-lucide="move-right"
                                        className="inline-block align-middle size-4 ltr:ml-1 rtl:mr-1"></i></a>
                            </div>
                        </div>
                        <div id="orderStatisticsChart" className="apex-charts"
                ...
                <div className="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div className="text-center card-body">
                        ...
                        <h5 className="mt-4 mb-2">$<span className="counter-value" data-target="236.18">0</span>k</h5>
                ...
                <div className="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div className="text-center card-body">
                        <div
                            className="flex items-center justify-center mx-auto text-purple-500 bg-purple-100 rounded-full size-14 dark:bg-purple-500/20">
                            <i data-lucide="package"></i>
                        </div>
                        <h5 className="mt-4 mb-2"><span className="counter-value" data-target="13461">0</span></h5>
                ...
                <div className="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div className="text-center card-body">
                        <div
                            className="flex items-center justify-center mx-auto text-green-500 bg-green-100 rounded-full size-14 dark:bg-green-500/20">
                            <i data-lucide="truck"></i>
                        </div>
                        <h5 className="mt-4 mb-2"><span className="counter-value" data-target="17150">0</span></h5>
                ...
                <div className="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div className="text-center card-body">
                        <div
                            className="flex items-center justify-center mx-auto text-red-500 bg-red-100 rounded-full size-14 dark:bg-red-500/20">
                            <i data-lucide="package-x"></i>
                        </div>
                        <h5 className="mt-4 mb-2"><span className="counter-value" data-target="3519">0</span></h5>
                        ...
                        <div className="flex flex-col gap-4 mb-4 md:mb-3 md:items-center md:flex-row">
                            ...
                            <div className="relative">
                                <i data-lucide="calendar-range"
                                    className="absolute size-4 ltr:left-3 rtl:right-3 top-3 text-slate-500 dark:text-zink-200"></i>
                                <input type="text"
                        ...
                        <div className="grid grid-cols-12 gap-4 mb-3">
                            <div className="col-span-12 md:col-span-6 lg:col-span-3">
                                <div className="flex items-center gap-3">
                                    <div
                                        className="flex items-center justify-center rounded-md size-12 text-sky-500 bg-sky-50 shrink-0 dark:bg-sky-500/10">
                                        <i data-lucide="bar-chart"></i>
                                    </div>
                                    <div className="grow">
                                        <p className="mb-1 text-slate-500 dark:text-zink-200">Total Sales</p>
                                        <h5 className="text-15">$<span className="counter-value" data-target="1517.36">0</span>k
                                        </h5>
                                    </div>
                                </div>
                            </div>
                            <div className="col-span-12 md:col-span-6 lg:col-span-3">
                                <div className="flex items-center gap-3">
                                    <div
                                        className="flex items-center justify-center text-green-500 rounded-md size-12 bg-green-50 shrink-0 dark:bg-green-500/10">
                                        <i data-lucide="trending-up"></i>
                                    </div>
                                    <div className="grow">
                                        <p className="mb-1 text-slate-500 dark:text-zink-200">Total Profit</p>
                                        <h5 className="text-15">$<span className="counter-value" data-target="746.84">0</span>k
                                        </h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div id="salesRevenueOverview" className="apex-charts"
                        ...
                        <div className="col-span-12 card lg:col-span-6 2xl:col-span-12">
                            <div className="card-body">
                                <div className="flex items-center mb-3">
                                    ...
                                    <div className="relative">
                                        <a href="#!"
                                            className="transition-all duration-300 ease-linear text-custom-500 hover:text-custom-700">View
                                ...
                                <div className="grid grid-cols-12">
                                    <div className="col-span-12 md:col-span-6 2xl:col-span-7">
                                        <div id="trafficResourcesChart" className="apex-charts"
                                    ...
                                    <div className="col-span-12 md:col-span-6 2xl:col-span-5">
                                        <ul className="flex flex-col gap-3">
                                            <li className="flex items-center gap-2">
                                                <div className="bg-green-500 size-3 shrink-0 clip-triangle"></div>
                                                <p className="text-green-500">Search Engine (22%)</p>
                                            </li>
                                            <li className="flex items-center gap-2">
                                                <div className="bg-purple-500 size-3 shrink-0 clip-triangle"></div>
                        ...
                        <div className="col-span-12 card lg:col-span-6 2xl:col-span-12">
                            <div className="card-body">
                                <div className="flex items-center mb-2">
                                    <h5 className="grow"><span className="counter-value" data-target="1596">0</span></h5>
                                    <span
                                        className="px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-white border-red-100 text-red-500 dark:bg-zink-700 dark:border-red-900"><i
                                            data-lucide="trending-down"
                                            className="inline-block size-3 ltr:mr-1 rtl:ml-1"></i> 6.8%</span>
                                </div>
                    ...
                    <div className="card-body">
                                ...
                                <div className="flex gap-3">
                                    <div className="relative grow">
                                        ...
                                        <i data-lucide="search"
                                            className="inline-block size-4 absolute ltr:left-2.5 rtl:right-2.5 top-2.5 text-slate-500 dark:text-zink-200 fill-slate-100 dark:fill-zink-600"></i>
                                    </div>
                                    <button type="button"
                                        className="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><i
                                            className="align-baseline ltr:pr-1 rtl:pl-1 ri-download-2-line"></i>
                                        Export</button>
                                </div>
                            </div>
                            {/* <!--end col--> */}
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full whitespace-nowrap">
                                <thead
                                    className="ltr:text-left rtl:text-right bg-slate-100 text-slate-500 dark:text-zink-200 dark:bg-zink-600">
                                    <tr>
                                        <th
                                            className="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold border-y border-slate-200 dark:border-zink-500">
                                            #
                                        </th>
                                        <th
                                            className="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold border-y border-slate-200 dark:border-zink-500">
                                ...
                                <tbody>
                                    <tr>
                                        <td
                                            className="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                            01
                                        </td>
                                        <td
                                            className="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                        ...
                                        <td
                                            className="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                            <span
                                                className="delivery_status px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-green-100 border-green-200 text-green-500 dark:bg-green-500/20 dark:border-green-500/20">Delivered</span>
                                        </td>
                                        <td
                                            className="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                            <div className="relative dropdown">
                                                <button id="orderAction1" data-bs-toggle="dropdown"
                                                    className="flex items-center justify-center size-[30px] dropdown-toggle p-0 text-slate-500 btn bg-slate-100 hover:text-white hover:bg-slate-600 focus:text-white focus:bg-slate-600 focus:ring focus:ring-slate-100 active:text-white active:bg-slate-600 active:ring active:ring-slate-100 dark:bg-slate-500/20 dark:text-slate-400 dark:hover:bg-slate-500 dark:hover:text-white dark:focus:bg-slate-500 dark:focus:text-white dark:active:bg-slate-500 dark:active:text-white dark:ring-slate-400/20"><i
                                                        data-lucide="more-horizontal" className="size-3"></i></button>
                                                    ...
                                                    <li>
                                                        <a className="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200"
                                                            href="apps-ecommerce-order-overview.html"><i
                                                                data-lucide="eye"
                                                                className="inline-block size-3 ltr:mr-1 rtl:ml-1"></i> <span
                                                                    className="align-middle">Overview</span></a>
                                                    </li>
                                                    <li>
                                                        <a className="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200"
                                                            href="#!"><i data-lucide="file-edit"
                                                                className="inline-block size-3 ltr:mr-1 rtl:ml-1"></i> <span
                                                                    className="align-middle">Edit</span></a>
                                                    </li>
                                                    <li>
                                                        <a className="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200"
                                                            href="#!"><i data-lucide="trash-2"
                                                                className="inline-block size-3 ltr:mr-1 rtl:ml-1"></i> <span
                                                                    className="align-middle">Delete</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            className="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                            <span
                                                className="delivery_status px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-purple-100 border-purple-200 text-purple-500 dark:bg-purple-500/20 dark:border-purple-500/20">Shipping</span>
                                        </td>
                                        <td
                                            className="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                            <div className="relative dropdown">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            className="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                            <span
                                                className="delivery_status px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-sky-100 border-sky-200 text-sky-500 dark:bg-sky-500/20 dark:border-sky-500/20">New</span>
                                        </td>
                                        <td
                                            className="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                            <div className="relative dropdown">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            className="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                            <span
                                                className="delivery_status px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-yellow-100 border-yellow-200 text-yellow-500 dark:bg-yellow-500/20 dark:border-yellow-500/20">Pending</span>
                                        </td>
                                        <td
                                            className="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                            <div className="relative dropdown">
                        ...
                        <div className="flex flex-col items-center mt-5 md:flex-row">
                            <div className="mb-4 grow md:mb-0">
                                <p className="text-slate-500 dark:text-zink-200">Showing <b>07</b> of <b>19</b> Results</p>
                            </div>
                            <ul className="flex flex-wrap items-center gap-2 shrink-0">
                                <li>
                                    <a href="#!"
                                        className="inline-flex items-center justify-center bg-white dark:bg-zink-700 h-8 px-3 transition-all duration-150 ease-linear border rounded border-slate-200 dark:border-zink-500 text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 hover:bg-custom-50 dark:hover:bg-custom-500/10 focus:bg-custom-50 dark:focus:bg-custom-500/10 focus:text-custom-500 dark:focus:text-custom-500 [&.active]:text-custom-500 dark:[&.active]:text-custom-500 [&.active]:bg-custom-50 dark:[&.active]:bg-custom-500/10 [&.active]:border-custom-50 dark:[&.active]:border-custom-500/10 [&.active]:hover:text-custom-700 dark:[&.active]:hover:text-custom-700 [&.disabled]:text-slate-400 dark:[&.disabled]:text-zink-300 [&.disabled]:cursor-auto"><i
                                            className="mr-1 size-4 rtl:rotate-180" data-lucide="chevron-left"></i> Prev</a>
                                </li>
                                <li>
                                    <a href="#!"
                                ...
                                <li>
                                    <a href="#!"
                                        className="inline-flex items-center justify-center bg-white dark:bg-zink-700 h-8 px-3 transition-all duration-150 ease-linear border rounded border-slate-200 dark:border-zink-500 text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 hover:bg-custom-50 dark:hover:bg-custom-500/10 focus:bg-custom-50 dark:focus:bg-custom-500/10 focus:text-custom-500 dark:focus:text-custom-500 [&.active]:text-custom-500 dark:[&.active]:text-custom-500 [&.active]:bg-custom-50 dark:[&.active]:bg-custom-500/10 [&.active]:border-custom-50 dark:[&.active]:border-custom-500/10 [&.active]:hover:text-custom-700 dark:[&.active]:hover:text-custom-700 [&.disabled]:text-slate-400 dark:[&.disabled]:text-zink-300 [&.disabled]:cursor-auto">Next
                                        <i className="ml-1 size-4 rtl:rotate-180" data-lucide="chevron-right"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div className="flex items-center gap-2">
                                    <div className="shrink-0">
                                        <i data-lucide="calendar-days"
                                            className="inline-block mb-1 align-middle size-4"></i>
                                    </div>
                                    <p className="mb-0 text-slate-500 dark:text-zink-200">This Month: <span
                                        className="font-medium text-slate-800 dark:text-zink-50">$13,741</span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul className="divide-y divide-slate-200 dark:divide-zink-500">
                            <li className="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div className="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="/assets/images/users/avatar-2.png" alt="" className="w-8 h-8 rounded-full" />
                                </div>
                                <div className="grow">
                            ...
                            <li className="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div className="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="/assets/images/users/avatar-3.png" alt="" className="w-8 h-8 rounded-full" />
                                </div>
                                <div className="grow">
                            ...
                            <li className="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div className="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="/assets/images/users/avatar-4.png" alt="" className="w-8 h-8 rounded-full" />
                                </div>
                                <div className="grow">
                            ...
                            <li className="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div className="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="/assets/images/users/avatar-5.png" alt="" className="w-8 h-8 rounded-full" />
                                </div>
                                <div className="grow">
                ...
                <div className="col-span-12 card lg:col-span-6 2xl:col-span-3">
                    <div className="card-body">
                        ...
                        <div className="flex items-center gap-3 my-3">
                            ...
                            <div className="grow">
                                <p className="mb-1 text-slate-500 dark:text-zink-200">Total Profit</p>
                                <h5 className="text-15">$<span className="counter-value" data-target="746.84">0</span>k</h5>
                            </div>
                        </div>
                        <div id="salesThisMonthChart" className="apex-charts"
                    ...
                    <div className="card-body">
                        ...
                        <ul className="flex flex-col gap-5">
                            <li className="flex items-center gap-3">
                                <div
                                    className="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                    <img src="/assets/images/product/img-02.png" alt="" className="h-6" />
                                </div>
                                ...
                                <h6 className="shrink-0"><i data-lucide="shopping-cart"
                                    className="inline-block align-middle size-4 text-slate-500 dark:text-zink-200 ltr:mr-1 rtl:ml-1"></i>
                                    798</h6>
                            </li>
                            <li className="flex items-center gap-3">
                                <div
                                    className="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                    <img src="/assets/images/product/img-03.png" alt="" className="h-6" />
                                </div>
                                <div className="overflow-hidden grow">
                            ...
                            <li className="flex items-center gap-3">
                                <div
                                    className="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                    <img src="/assets/images/product/img-04.png" alt="" className="h-6" />
                                </div>
                                <div className="overflow-hidden grow">
                            ...
                            <li className="flex items-center gap-3">
                                <div
                                    className="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                    <img src="/assets/images/product/img-05.png" alt="" className="h-6" />
                                </div>
                                <div className="overflow-hidden grow">
                            ...
                            <li className="flex items-center gap-3">
                                <div
                                    className="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                    <img src="/assets/images/product/img-06.png" alt="" className="h-6" />
                                </div>
                                <div className="overflow-hidden grow">
                ...
                <div className="col-span-12 card lg:col-span-6 2xl:col-span-3">
                    <div className="card-body">
                        ...
                        <div id="audienceChart" className="-mt-9 apex-charts"
            ...
            {/* <!--apexchart js--> */}
            <Script src="/assets/libs/apexcharts/apexcharts.min.js" strategy="afterInteractive" ></Script>

            {/* <!--dashboard ecommerce init js--> */}
            <Script src="/assets/js/pages/dashboards-ecommerce.init.js" strategy="afterInteractive" ></Script>
        </>
    )
}
